...
The mean and median of the total number of steps per day are `r mean_step` and `r median_step`, respectively.
...
``` {r question 3.1 inpute with mean, fig.width = 9}
...
``` {r question 3.2 inpute with median, fig.width = 9}
